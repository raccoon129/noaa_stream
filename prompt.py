...
def construir_prompt(cna, owm, aqi, forecast=None, contexto_sismo=None,
    ...
    prompt = (
        ...
        "La FUENTE 3 la presenta como 'valor | etiqueta'. La etiqueta puede incluir un complemento "
        "de origen, incorpóralo de forma natural en la narrativa cuando esté presente. "
        ...
        "19. Polvo (FUENTE 3): si aparece la línea 'Polvo en suspensión', intégrala al final del párrafo de calidad del aire en lenguaje natural. "
        "Si el porcentaje >30% enfatízalo; si ≤15% mención breve y sin alarmar. Si la línea no aparece, no menciones polvo.\n\n"

        "20. Radiación solar (FUENTE 4): si aparece 'Radiación solar máxima proyectada', tradúcela a lenguaje cotidiano sin mencionar W/m²: "
        "<200=cielo cubierto, 200-500=sol con intervalos, 500-800=día soleado, >800=sol intenso. "
        "Intégrala al final del párrafo de condiciones o UV según el contexto climático actual. Si es horario nocturno, OMITE.\n\n"
